        ...
        <a href="#"class="navbar-brand">MTN-linkok</a> 
           ...
           <div class="collapse navbar-collapse d-center" id="navbarCollapse">
               <ul class="navbar-nav ml-auto">
                   <li class="nav-item">
				   <a href="{{route('mainPages.about')}}"class="nav-link {{Request::is("about")? "myactive":""}}" id="about">about</a>
                   </li>
                   <li class="nav-item" id="blog">
				   <a href="{{route('mainPages.blog')}}"class="nav-link {{Request::is("blog")? "myactive":""}}"">blog</a>
                   </li>
                   <li class ="nav-item">
                   <a href="{{route("mainPages.contact")}}"class="nav-link {{Request::is("contact")? "myactive":""}}"" id="contact">contact</a>
                   </li>
                   <li class="nav-item">
                       <a href="{{route("mainPages.share")}}" class="nav-link {{Request::is("share")? "myactive":""}}"" id="share" >share</a>
                   </li>
                   <li class="nav-item">
                    <a href="{{route("mainPages.support")}}" class="nav-link {{Request::is("support")? "myactive":""}}"" id="support">support</a>
                   </li>
               </ul>
           </div>
        </div>
	...
	<footer class="footer-area section_gap ">
		<div class="container mt-5 py-5">
			...
			<div class="footer-bottom d-flex justify-content-between align-items-center flex-wrap">
				<div>
					<p class="text-white  text-center text-4"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
